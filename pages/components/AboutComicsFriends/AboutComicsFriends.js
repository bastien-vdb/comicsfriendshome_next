...
import stripeComicsImg from '/public/Stripes_pic.png';

function AboutComicsFriends(props) {
    
    return (
        <div className='bg-about h-[100vh]'>
            <div className='relative p-6 flex h-full items-center justify-center lg:py-20 lg:px-64' id='blocAbout'>
