                ...
                <div className='PrivacyAndPolicy text-sm md:text-base py-24 px-4 sm:px-32 md:px-32 lg:px-44 xl:px-80 flex flex-col gap-10'>
                    <div className='aboutComicsFriendsBloc p-6 sm:p-12 rounded-2xl'>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Comics Friends, accessible from <a href="https://comicsfriends.io/" rel="external nofollow noopener" target="_blank">https://comicsfriends.io/</a></p>
                            </li>
                            <li>
                                <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
                            </li>
                        </ul>
                        <h1 className='title'>Collecting and Using Your Personal Data</h1>
                        ...
                        <ul>
                            <li><a href=''>By email: info@comicsfriends.io</a></li>
                        </ul>
                    </div>
                </div>
            </main>
