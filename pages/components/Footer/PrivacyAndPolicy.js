...
function PrivacyAndPolicy(props) {
    return (
        <>
            <Head>
                <title>Privacy Policy - Comicsfriends</title>
            ...
            <main>
                ...
                <div className='PrivacyAndPolicy py-24 px-10 sm:px-32 md:px-32 lg:px-44 xl:px-80 flex flex-col gap-10'>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Comicsfriends, 23 Quai voltaire, 75007, Paris.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Comics Friends, accessible from <a href="https://comicsfriends.art/" rel="external nofollow noopener" target="_blank">https://comicsfriends.art/</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li><a href=''>By email: info@comicsfriends.art</a></li>
                    </ul>
