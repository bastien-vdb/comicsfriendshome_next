    ...
    return (
        <div className='mt-20 p-10 text-sm sm:text-base flex flex-col items-center'>
            ...
            <div className='flex justify-center items-start gap-4 flex-col sm:flex-row sm:gap-8'>
                ...
                <div className='text-justify w-11/12 sm:w-96 sm:mt-20'>
                    <p>The first Comics friends collection will be a collection by world renowned artist MOEBIOS</p>
                    <p>JEAN GIRAUD was a french artist, cartoonist, and writer. He has been described as the most influential “Bande Dessinee” artist. His most famous works include the series Blue-Berry. Arzach. The Inicial and many more...</p>
