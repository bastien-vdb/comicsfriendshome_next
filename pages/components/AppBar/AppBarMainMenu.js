...
const NavigationBar = () => {
    ...
    const pages = [
        ...
        { name: 'Genesis', link: '/#anchor_Genesis' },
    ...
    return (
        <nav className='fixed z-30 top-0 w-full'>
            <div className='deskTopMenu flex justify-between items-center mb-2 relative border-b px-8 py-1 shadow-4xl shadow-lg shadow-[#9850b3]'>
                <Link href='/'>
            ...
            <div className='mobileMenu hidden mb-2 relative border-b px-8 py-1 shadow-4xl shadow-lg shadow-[#9850b3]'>
                <div className='flex justify-between'>
                    <Link href='/'>
                        <Image alt='logo.png' src='/images/logov3.png' className='m-2' height={500} width={100} />
                    </Link>
...
const DeskTopButton = ({ pages }) => {
    return (
        <>
            <li className='desktopButton group relative border-2 rounded-full px-6 text-sm py-1 shadow-4xl shadow-lg shadow-[#9850b3] cursor-pointer'>
